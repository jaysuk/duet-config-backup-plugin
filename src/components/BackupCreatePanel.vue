			...
			<v-expansion-panels variant="accordion">
				<v-expansion-panel>
					...
					<v-expansion-panel-text>
						<div class="text-caption text-medium-emphasis mb-2">{{ $t("plugins.duetConfigBackup.configBackup.create.exclusionsHelp") }}</div>
...
function onExclude(name: string): void {
	...
	toast.text = i18n.global.t("plugins.duetConfigBackup.configBackup.redaction.excludeToast", { name });
	toast.open = true;
}
